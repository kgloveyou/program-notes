...
1.  为什么只能在函数最外层调用Hook，不要在循环、条件判断或者子函数中调用？
...
2.  基于 useState 的用法，我们尝试着自己实现一个 useState：demo2：https://codesandbox.io/s/myy5qvoxpp
...
![image](https://mmbiz.qpic.cn/mmbiz_png/2K5IuDFDWm9XhkUia7ADhC6ArNTcGJaNYtxlmp3HhfF8tAiagLkQq0YPyurLXFoWD35woB1VHWN2qdkSwBVJ62bQ/640?wx_fmt=png&wxfrom=5&wx_lazy=1&wx_co=1)

原文地址：https://github.com/brickspert/blog/issues/26