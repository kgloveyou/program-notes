...
-   -   [实现方案](#_14)
-   [一、docx文件实现前端预览](#docx_27)
-   -   [1、docx-preview](#1docxpreview_29)
    -   [2、Mammoth](#2Mammoth_53)
-   [二、PDF文件实现前端预览](#PDF_69)
-   -   [1、pdf.js](#1pdfjs_71)
    -   [2、pdfobject.js](#2pdfobjectjs_91)
    -   [3、vue-pdf](#3vuepdf_105)
    -   [4、iframe / object/ embed](#4iframe__object_embed_129)
-   [三、Excel文件实现前端预览](#Excel_144)
-   -   [1、sheetjs js-xlsx](#1sheetjs__jsxlsx_146)
    -   [2、canvas-datagrid](#2canvasdatagrid_183)
    -   [3、 handsontable](#3_handsontable_199)
    -   [4、DataTables](#4DataTables_229)
-   [四、pptx文件实现前端预览](#pptx_256)
-   -   [1、PPTXJS](#1PPTXJS_258)
-   [总结](#_290)
-   -   [1、前端根据不同文件类型使用对应的在线预览组件进行在线预览。](#1_294)
    -   [2、后端配合将不同格式的文件转换成pdf，转成统一的文件格式，再由前端实现预览效果](#2pdf_298)
...
### 4、iframe / object/ [embed](https://so.csdn.net/so/search?q=embed&spm=1001.2101.3001.7020)
