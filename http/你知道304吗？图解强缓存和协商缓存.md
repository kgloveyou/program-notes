...
![百度状态码](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/ceb3cf8156a34d808dc8ad9189b04313~tplv-k3u1fbpfcp-zoom-1.image)
...
浏览器地址输入：www.360buy.com

**General**

```
Request URL: https://www.360buy.com/
Request Method: GET
Status Code: 301 Moved Permanently
Remote Address: 61.139.244.3:443
...
Date: Fri, 15 Apr 2022 02:16:31 GMT
Location: http://www.jd.com/
Server: nginx
Timing-Allow-Origin: *
Via: http/1.1 ORI-CLOUD-HUB-MIX-116 (jcs [cRs f ]), http/1.1 NN-CT-4-MIX-22 (jcs [cRs f ])
X-Trace: 301-1649988419498-0-0-0-0-0;301-1649988503693-0-0-0-15-15;301-1649988991169-0-0-0-1-1
```
...
![强制缓存 图1](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/b5f04f37b588462ab7abf025cfa7c5a8~tplv-k3u1fbpfcp-zoom-1.image)
...
![强制缓存 图2](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/2a925e79ee724f1099df19d9e61fff32~tplv-k3u1fbpfcp-zoom-1.image)
...
![强制缓存 图3](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/52e861b7bcd4445f861147fe24e08ac1~tplv-k3u1fbpfcp-zoom-1.image)
...
![协商缓存 图1](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/5684907367bc4101b4e3f4bc23cdb760~tplv-k3u1fbpfcp-zoom-1.image)
...
之后如果浏览器再次发送请求时，浏览器就会带上这个资源标识。此时，服务端就会通过这个资源标识，可以判断出浏览器的资源跟服务端此时的资源是否一致，如果一致，则返回304，即表示Not Modified 资源未修改。如果判断结果为不一致，则返回200，并返回资源以及新的资源标识。至此就结束了协商缓存的过程。

------

接下来看第二张图。

![协商缓存 图2](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/ad59e3c8cf7a4399857021563503135a~tplv-k3u1fbpfcp-zoom-1.image)
...
![协商缓存 图3](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/a1b3c3bc7e5741809fc6397cebae4f1c~tplv-k3u1fbpfcp-zoom-1.image)
...
![Headers 实例](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/626d5061d90c4089805063a000d41bc7~tplv-k3u1fbpfcp-zoom-1.image)
...
![协商缓存流程图](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/6bab9cf4e4d64d9491934fa506881c09~tplv-k3u1fbpfcp-zoom-1.image)
...
http协议对于开发来说时很重要很重要的一块内容，不管是前端还是后端，对于常见的状态码，请求方法请求头和响应头，还有强缓存和协商缓存都是必须要了解的知识点。

关于http协议的知识就讲到这里啦！如有疑问或文章有误欢迎评论区留言或私信我交流🧐
